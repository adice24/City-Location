      ...
      >
        <div
          className={cn(
            ...
            gradient,
            "backdrop-blur-[1px] border-2 border-black/[0.05]",
...
export default function GeometricBackground({
  ...
  return (
    <div
      className={cn("relative w-full overflow-hidden bg-[#F8F9FA]", className)}
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-[#F8F9FA] via-transparent to-[#F8F9FA]/80 pointer-events-none" />
    </div>
  );
}
